...
public class Action {
	...
	public static void main(String[] args) throws Exception {
		...
		//String querySQL = "SELECT * FROM customer";   //OK anche con rabbitMQ
		//String querySQL = "SELECT * FROM address"; //OK anche con rabbitMQ
		//String querySQL = "SELECT * FROM city"; //OK anche con rabbitMQ 
		//String querySQL = "SELECT * FROM country"; //OK anche con rabbitMQ
		//String querySQL = "SELECT * FROM store";   //OK anche con rabbitMQ
	    //String querySQL = "SELECT * FROM rental"; //OK anche con rabbitMQ
	    //String querySQL = "SELECT * FROM payment"; //OK anche con rabbitMQ
	    //String querySQL = "SELECT * FROM staff"; //OK anche con rabbitMQ
		
		//String querySQL = "SELECT * FROM address, customer WHERE customer.address_id = address.address_id AND address.phone = '1234'"; //OK anche con rabbitMQ
		//String querySQL = "SELECT * FROM address, customer, city WHERE customer.address_id = address.address_id AND address.city_id = city.city_id AND city.city = 'Roma'"; //OK anche con rabbitMQ
		//String querySQL = "SELECT * FROM address, customer, city WHERE customer.address_id = address.address_id AND address.city_id = city.city_id"; ////OK anche con rabbitMQ
